...
public class NextGreaterElement2 {
    ...
    // PUSH: Every incoming number's index will be pushed on to the stack for first N runs by default
    // POP: If incoming number is greater than number at TOS index, then keep popping
