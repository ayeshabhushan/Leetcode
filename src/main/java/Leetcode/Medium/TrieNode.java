...
public class TrieNode 
{
	...
	public void addWord(String word, int index) 
	{
		...
		// Now since, the node is created in the array, increase the index and send this for processing in a recursive call
	...
	public boolean search(String word, int idx) 
	{
		...
		// If the character is not dot but is some alphabet, send the recursive call by incrementing the index. 
		if (c != '.') 
		{
