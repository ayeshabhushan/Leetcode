...
public class MinHeap {
    ...
    private void insertKey(int k) {
        ...
        // First insert the new key at the end. Increase the size to find the last index.
        currentSize++;
        int i = currentSize - 1;

        // Then store the element at the new index
        heapArray[i] = k;
    ...
    private int extractMin() {
        ...
        // Step 2: You delete the element at the last index.
        currentSize--;
    ...
    private void heapify(int i) {
        ...
        // If smallest index isn't the parent itself, swap the parent and smallest index.
        if (smallest != i) {
            swap(i, smallest);
