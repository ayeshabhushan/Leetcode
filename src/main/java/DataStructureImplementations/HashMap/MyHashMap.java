...
public class MyHashMap<K, V> 
{
	...
	public void put(K key, V value) 
	{
		...
		// Step 4: Since we have to store a new node, generate the index for this key
		int index = getIndexForKey(key);
		
		// Step 5: Append this node to the front of the chain at this index
	...
	{
		// Step 1 : Hash the key to get the index
		int index = getIndexForKey(key);
		
		// Step 2 : Fetch the head of the chain at this index
